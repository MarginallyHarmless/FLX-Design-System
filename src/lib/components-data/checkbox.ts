...
export const checkboxSpec: ComponentSpec = {
  ...
  name: "Checkbox",
  description:
    "Vanilla HTML/CSS/JS implementation of the Checkbox component, matching Figma pixel-for-pixel. Supports selected, error, disabled, border, inverted, and size variants.",
  status: "stable",
  figmaLink:
