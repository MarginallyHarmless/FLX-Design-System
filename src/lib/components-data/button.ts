...
export const buttonSpec: ComponentSpec = {
  ...
  name: "Button",
  description:
    "Primary interactive element for triggering actions. Supports Brand, Danger, and Success scopes with Primary, Secondary, and Tertiary variants across four sizes.",
  status: "stable",
