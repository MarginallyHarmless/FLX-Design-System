...
export const radioSpec: ComponentSpec = {
  ...
  name: "Radio",
  description:
    "Allows users to select exactly one option from a set of mutually exclusive choices. Displayed within a bordered input container with an optional label, value text, and error indicator.",
  status: "stable",
