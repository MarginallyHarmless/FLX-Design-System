...
export const selectFieldSpec: ComponentSpec = {
  slug: "select-field",
  name: "Select Field",
  description: "Dropdown for choosing one or more options from a predefined list, with chip-based multi-select.",
  status: "stable",
  ...
  variantStyles: [
    ...
    // ── Disabled × Medium × Off ──
    {
      ...
      elements: {
        ...
        PrefixSuffix: { textColor: "#64748b", fontSize: 14, lineHeight: 24 },
        Chip: { fill: "#cbd1db", textColor: "#475263", cornerRadius: 8, fontSize: 14, lineHeight: 24 },
        ChipCount: { textColor: "#006bd8", fontSize: 14, lineHeight: 24 },
        CaretDown: { width: 24, height: 24 },
    ...
    // ── Disabled × Medium × On ──
    {
      ...
      elements: {
        ...
        Placeholder: { textColor: "#8390a2", fontSize: 14, lineHeight: 24 },
        PrefixSuffix: { textColor: "#64748b", fontSize: 14, lineHeight: 24 },
        Chip: { fill: "#5b6a7e", textColor: "#cbd1db", cornerRadius: 8, fontSize: 14, lineHeight: 24 },
        ChipCount: { textColor: "#006bd8", fontSize: 14, lineHeight: 24 },
        CaretDown: { width: 24, height: 24 },
        Description: { textColor: "#64748b", fontSize: 12, lineHeight: 16 },
        InfoIcon: { width: 14, height: 14 },
    ...
    // ── Disabled × Small × Off ──
    {
      ...
      elements: {
        ...
        PrefixSuffix: { textColor: "#64748b", fontSize: 12, lineHeight: 16 },
        Chip: { fill: "#cbd1db", textColor: "#475263", cornerRadius: 6, fontSize: 12, lineHeight: 16 },
        ChipCount: { textColor: "#006bd8", fontSize: 12, lineHeight: 16 },
        CaretDown: { width: 16, height: 16 },
        Description: { textColor: "#64748b", fontSize: 12, lineHeight: 16 },
        InfoIcon: { width: 12, height: 12 },
    ...
    // ── Disabled × Small × On ──
    {
      ...
      elements: {
        ...
        Placeholder: { textColor: "#8390a2", fontSize: 12, lineHeight: 16 },
        PrefixSuffix: { textColor: "#64748b", fontSize: 12, lineHeight: 16 },
        Chip: { fill: "#5b6a7e", textColor: "#cbd1db", cornerRadius: 6, fontSize: 12, lineHeight: 16 },
        ChipCount: { textColor: "#006bd8", fontSize: 12, lineHeight: 16 },
        CaretDown: { width: 16, height: 16 },
        Description: { textColor: "#64748b", fontSize: 12, lineHeight: 16 },
        InfoIcon: { width: 12, height: 12 },
