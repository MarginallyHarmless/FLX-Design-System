...
/* ------------------------------------------------------------------ */
/*  Standalone-checkbox preview — illustrates "no label" usage in a    */
/*  user-list context, matching the screenshot in the spec.            */
/* ------------------------------------------------------------------ */
...
function StandaloneUserListPreview() {
  return (
    ...
    >
      {/* Row 1 — registered user, unchecked */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <FlowXCheckbox selected={false} border={false} hasLabel={false} value="" />
      </div>

      {/* Row 2 — pending invite, checked */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <FlowXCheckbox selected={true} border={false} hasLabel={false} value="" />
      </div>
    </div>
  );
}
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Value text + optional inline description (skipped when standalone) */}
